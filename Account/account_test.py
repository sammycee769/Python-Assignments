...
class TestAccount(unittest.TestCase):
    ...
    def test_that_deposit_5k_twice_gives_balance_10k(self):
        balance = self.account.check_balance("1234")
        self.assertEqual(balance, 0)
        self.account.deposit(5000)
        self.account.deposit(5000)
    ...
    def test_that_negative_deposit_does_not_change_balance(self):
        balance = self.account.check_balance("1234")
        self.assertEqual(balance, 0)
        self.account.deposit(-5000)
        balance = self.account.check_balance("1234")
    ...
    def test_that_deposit_5k_and_withdraw_2k_gives_balance_3k(self):
        balance = self.account.check_balance("1234")
        self.assertEqual(balance, 0)
        self.account.deposit(5000)
    ...
    def test_that_withdraw_more_than_balance_does_not_change_balance(self):
        balance = self.account.check_balance("1234")
        self.assertEqual(balance, 0)
        self.account.deposit(5000)
    ...
    def test_that_negative_withdraw_does_not_change_balance(self):
        balance = self.account.check_balance("1234")
        self.assertEqual(balance, 0)
        self.account.deposit(5000)
        self.account.withdraw(-2000, "1234")
    ...
    def test_that_withdraw_exact_balance_gives_zero_balance(self):
        balance = self.account.check_balance("1234")
        self.assertEqual(balance, 0)
        self.account.deposit(5000)
